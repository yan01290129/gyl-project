<template>
  <div>
    ...
    <data-table v-loading='loading' :data.sync="data" :count.sync="count" :configs.sync="configs" :ruleData.sync="ruleData" :ruleConfigs.sync="ruleConfigs" :operationConfigs='optionConfigs' @handlerRuleChange='ruleChange' @handlerCurrentSelected='currentSelected' @handlerOperation='operation'>
